...
const PaymentPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-deep-void pt-20 px-6">
      <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-2xl w-full max-w-lg">
        <h1 className="text-4xl font-black uppercase mb-8 text-center text-gray-800 dark:text-white tracking-tight">Payment Method</h1>
        ...
        <form onSubmit={submitHandler} className="space-y-6">
          ...
          <label className={`flex items-center gap-4 p-6 border-2 rounded-xl cursor-pointer transition-all ${
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Credit Card, Debit Card, UPI, Netbanking</p>
              </div>
            </div>
          </label>
          ...
          <label className={`flex items-center gap-4 p-6 border-2 rounded-xl cursor-pointer transition-all opacity-50 ${
            paymentMethod === 'UPI' 
            ? 'border-black dark:border-white bg-black/5 dark:bg-white/5' 
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div>
                <p className="font-bold text-lg">UPI Direct <span className="text-xs text-gray-400">(Coming Soon)</span></p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Pay via GPay, PhonePe, Paytm</p>
              </div>
            </div>
          </label>
