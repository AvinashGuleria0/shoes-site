...
const UserOrderDetailsPage = () => {
    ...
    return (
        <div className="pt-24 pb-20 min-h-screen bg-gray-50 dark:bg-deep-void text-gray-900 dark:text-white transition-colors">
            <div className="container mx-auto px-6 max-w-4xl">
                <Link to="/profile" className="inline-flex items-center gap-2 mb-8 text-sm font-bold uppercase tracking-widest text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">
                    <FaArrowLeft /> Back to Profile
                </Link>

                <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-zinc-800 mb-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-8 border-b border-gray-100 dark:border-zinc-800">
                        <div>
                            <h1 className="text-3xl font-black uppercase tracking-tighter mb-2">Order #{order._id.substring(order._id.length - 8)}</h1>
                            <p className="text-sm font-bold text-gray-500">Placed on {new Date(order.createdAt).toLocaleDateString()}</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
                        <div>
                            <h3 className="font-bold uppercase text-xs text-gray-500 mb-4 flex items-center gap-2">
                                <FaMapMarkerAlt /> Shipping Address
                            </h3>
                            <div className="bg-gray-50 dark:bg-black p-6 rounded-2xl text-sm font-bold leading-relaxed">
                        ...
                        <div>
                             ...
                             <div className="bg-gray-50 dark:bg-black p-6 rounded-2xl text-sm font-bold">
                    ...
                    <div>
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-zinc-800 border border-gray-100 dark:border-zinc-800 rounded-2xl overflow-hidden">
                            {order.orderItems.map((item, index) => (
                                <div key={index} className="flex items-center gap-6 p-6 bg-gray-50 dark:bg-black/50 hover:bg-white dark:hover:bg-zinc-900 transition-colors">
                                    <div className="w-16 h-16 bg-white dark:bg-zinc-800 rounded-lg p-2 flex items-center justify-center border border-gray-100 dark:border-zinc-700">
                                        <img 
